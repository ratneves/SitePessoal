    ...
    caseStudies: {
      ...
      items: [
        ...
        },
        {
          ...
          results: [
            { value: "14.660h", label: "poupadas por ano, soma de todos os processos" },
            { value: "9.360h", label: "eliminação de extrações manuais de 6 ERPs/DMSs" },
            { value: "1.920h", label: "fecho mensal e consolidação de 10 empresas" },
            { value: "1.040h", label: "gestão e otimização de stocks (peças e viaturas)" },
            { value: "2.340h", label: "relatórios ad-hoc self-service em 40+ dashboards" },
          ],
        },
      ],
    },
    ...
    caseStudies: {
      ...
      items: [
        ...
        },
        {
          ...
          results: [
            { value: "14,660h", label: "saved per year, across all processes" },
            { value: "9,360h", label: "eliminated manual extraction from 6 ERPs/DMSs" },
            { value: "1,920h", label: "monthly close and consolidation across 10 companies" },
            { value: "1,040h", label: "stock optimization (parts and vehicles)" },
            { value: "2,340h", label: "ad-hoc self-service reporting on 40+ dashboards" },
          ],
        },
      ],
    },
